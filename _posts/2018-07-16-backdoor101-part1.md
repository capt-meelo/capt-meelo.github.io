...
![Program Flow](/static/img/2018-07-16-backdoor101-part1/01.png)
...
![Detection1](/static/img/2018-07-16-backdoor101-part1/02.png)
...
![Lord PE](/static/img/2018-07-16-backdoor101-part1/03.png)

A new section header called **.NewSec** is created. Let’s set its size by editing this new section header. 
![New Section1](/static/img/2018-07-16-backdoor101-part1/04.png)
...
![New Section2](/static/img/2018-07-16-backdoor101-part1/05.png)
...
![Error](/static/img/2018-07-16-backdoor101-part1/06.png)
...
![XVI1](/static/img/2018-07-16-backdoor101-part1/07.png)
...
![Detection2](/static/img/2018-07-16-backdoor101-part1/11.png)
...
![Entry Point](/static/img/2018-07-16-backdoor101-part1/12.png)
...
![New Section Location](/static/img/2018-07-16-backdoor101-part1/13.png)
...
![Jump to Code Cave](/static/img/2018-07-16-backdoor101-part1/14.png)
...
![Hijacked](/static/img/2018-07-16-backdoor101-part1/15.png)

A new window pops up. Just _**right-click**_ again and select _**Save file**_. Let’s save the file as **putty1.exe**.
![Save File](/static/img/2018-07-16-backdoor101-part1/16.png)
...
![Jump Instuction](/static/img/2018-07-16-backdoor101-part1/17.png)
...
![Save Registers & Flags](/static/img/2018-07-16-backdoor101-part1/18.png)

Then, let’s generate a shellcode in hex format using MSFvenom. This can be done using the following command:
![MSFvenom](/static/img/2018-07-16-backdoor101-part1/19.png)
...
![Binary Paste](/static/img/2018-07-16-backdoor101-part1/20.png)

Here’s what our updated code looked like. 
![Shellcode](/static/img/2018-07-16-backdoor101-part1/21.png)
...
![Fix Shellcode](/static/img/2018-07-16-backdoor101-part1/22.png)
...
![Hanged](/static/img/2018-07-16-backdoor101-part1/23.png)
...
![Shell Received](/static/img/2018-07-16-backdoor101-part1/24.png)

Let’s try executing a command on our shell. 
![Execute Command](/static/img/2018-07-16-backdoor101-part1/25.png)

Doing that causes the debugger to run again. As seen, the breakpoint is hit and `ESP = 0x0012FD9C`.
![Debugger Runs](/static/img/2018-07-16-backdoor101-part1/26.png)
...
![Hang2](/static/img/2018-07-16-backdoor101-part1/27.png)

Let’s try exiting from our shellcode.
![Exit Shellcode](/static/img/2018-07-16-backdoor101-part1/28.png)

As seen, the debugger is running again. 
![Breakpoint Hit](/static/img/2018-07-16-backdoor101-part1/29.png)
...
![Terminate](/static/img/2018-07-16-backdoor101-part1/30.png)
...
![NOPed](/static/img/2018-07-16-backdoor101-part1/31.png)

When we run the new program, we’re now redirected to the location right after the shellcode. 
![NOP Worked](/static/img/2018-07-16-backdoor101-part1/32.png)
...
![SEH](/static/img/2018-07-16-backdoor101-part1/36.png)
...
![Putty-SEH](/static/img/2018-07-16-backdoor101-part1/37.png)
...
![Fixed](/static/img/2018-07-16-backdoor101-part1/38.png)

If we continue running the program, putty open ups without any errors.
![Putty Runs](/static/img/2018-07-16-backdoor101-part1/39.png)

And we gained a shell on our attacking machine.
![Shell](/static/img/2018-07-16-backdoor101-part1/40.png)
...
![Detection3](/static/img/2018-07-16-backdoor101-part1/41.png)
